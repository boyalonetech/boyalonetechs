  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Intro Text */}
        <div className="space-y-6  space-x-0 -mt-10 lg:-mt-0 w-full">
          ...
          <p className="text-lg text-gray-600 leading-relaxed text-justify hyphen-0">
          ...
          <p className="text-gray-600 leading-relaxed text-justify hyphen-0">
      ...
      {/* CTA */}
      <div className="mt-20 max-w-lg mx-auto bg-gradient-to-br from-blue-600 to-purple-600 p-8 rounded-3xl shadow-2xl text-center text-white">
