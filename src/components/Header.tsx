...
export default function Header() {
  ...
  return (
    <div className="fixed left-4 right-4 lg:right-0 lg:left-0 z-20 px-4 py-1 lg:p-4 items-center lg:rounded-none rounded-3xl lg:rounded-bl-2xl shadow-md lg:ml-auto w-auto lg:w-max backdrop-blur-2xl lg:block head bg-[#ffffffb7] top-4 lg:top-0 transition-all duration-500">
      {/* Desktop Nav */}
