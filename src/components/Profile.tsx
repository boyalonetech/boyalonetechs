    ...
    <>
      <aside className="w-full lg:profile lg:max-w-[280px] xl:max-w-[350px] sm:w-full sm:max-w-[350px] mt-1 lg:mt-2 pb-6 rounded-none dar border-gray-800  sm:rounded-xl prof shadow-lg h-[97vh] overflow-y-scroll md:max-w-full sm:ml-[4px]">
        ...
        <div className="mt-40 lg:mt-30 text-center px-3 pb-2 w-full">
          ...
          <p className="flex items-center justify-center gap-1 text-sm lg:text-[13px] xl:text-[16px]  text-gray-500 mt-2">
          ...
          <div className="border-t mt-6 pt-4 space-y-4 text-sm -600 text-left">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/10 p-5 rounded-2xl shadow-md border border-white/20">
              ...
              <ul className="space-y-3 lg:text-xs xl:text-sm">
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-3 px-4 rounded-lg transition-colors duration-200"
              >
                <Download size={20} />
