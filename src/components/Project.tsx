      ...
      <div className="flex flex-wrap justify-around gap-10 lg:gap-y-10 ">
        {projects.map((project) => (
          ...
          >
            ...
            {/* Overlay */}
            <div className="absolute bottom-0 left-0 w-full h-[60%] bg-gradient-to-t from-blue-500 to-blue-500 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out p-4 flex flex-col justify-end">
