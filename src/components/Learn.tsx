...
export default function MyJourneyBlog() {
  ...
  return (
    <section className="bg-gradient-to-br from-blue-500/10 to-blue-500/10 backdrop-blur-lg rounded-md lg:rounded-3xl shadow-xl max-w-5xl lg:mx-auto p-6 lg:p-12 mb-16 relative overflow-hidden">
      {/* Decorative Blobs */}
